...
insert into Gruppo (nome, descrizione) values 
    ...
    ("MESVA", "Medicina clinica sanit√† pubblica scienze della vita e dell'ambiente"), 
...
insert into Aula (nome, capienza, emailResponsabile, note, numeroPreseRete, numeroPreseElettriche, gruppoID, posizioneID ) values
    ...
    ("A1.2",46, "mattia.peccerill0o@student.univaq.it","la tenda della finestra √® rotta", 1, 4, 1, 2),
    ("A1.3",46, "mattia.peccerill0o@student.univaq.it","", 1, 4, 1, 2),
    ("A1.4",46, "mattia.peccerill0o@student.univaq.it","la tenda della finestra √® rotta", 1, 4, 1, 2),
...
insert into Corso(nome) values
    ...
    ("Tecnologie del web"),
    ("Web engineering"),
	("Teoria della calcolabilit‡ e della complessit‡"),
	("Informatica Forense"),
    ("Inglese B2"),
