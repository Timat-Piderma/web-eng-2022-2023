    ...
    private void action_evento(HttpServletRequest request, HttpServletResponse response, int IDaula, String data) throws IOException, ServletException, TemplateManagerException {
        try {
            ...
            if (eventi != null) {
                ...
                LocalDate primoGiornoSettimana = giornoCorrente.with(TemporalAdjusters.nextOrSame(DayOfWeek.MONDAY));
                LocalDate secondoGiornoSettimana = giornoCorrente.with(TemporalAdjusters.nextOrSame(DayOfWeek.TUESDAY));
                LocalDate terzoGiornoSettimana = giornoCorrente.with(TemporalAdjusters.nextOrSame(DayOfWeek.WEDNESDAY));
                LocalDate quartoGiornoSettimana = giornoCorrente.with(TemporalAdjusters.nextOrSame(DayOfWeek.THURSDAY));
                LocalDate quintoGiornoSettimana = giornoCorrente.with(TemporalAdjusters.nextOrSame(DayOfWeek.FRIDAY));
                LocalDate sestoGiornoSettimana = giornoCorrente.with(TemporalAdjusters.nextOrSame(DayOfWeek.SATURDAY));
                LocalDate settimoGiornoSettimana = giornoCorrente.with(TemporalAdjusters.nextOrSame(DayOfWeek.SUNDAY));
